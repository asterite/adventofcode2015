...
a = circuit.value_of("a")

# Instead of resetting the circuit, we just create a new one
# (by reparsing the input) and set the value of "b"
circuit = build_circuit(input)
circuit.set_value("b", FixedValue.new(a))
